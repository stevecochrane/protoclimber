...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		data = '{"name":null,"assets":"aoy4:pathy45:assets%2Fimages%2Ftilesets%2Fprotoclimber.pngy4:sizei294y4:typey5:IMAGEy2:idR1y7:preloadtgoR0y34:assets%2Fdata%2Fprotoclimber-1.tmxR2i1282R3y4:TEXTR5R7R6tgoR2i39706R3y5:MUSICR5y28:flixel%2Fsounds%2Fflixel.mp3y9:pathGroupaR10y28:flixel%2Fsounds%2Fflixel.ogghR6tgoR2i8220R3R9R5y26:flixel%2Fsounds%2Fbeep.mp3R11aR13y26:flixel%2Fsounds%2Fbeep.ogghR6tgoR2i6840R3y5:SOUNDR5R14R11aR13R14hgoR2i33629R3R15R5R12R11aR10R12hgoR2i15744R3y4:FONTy9:classNamey35:__ASSET__flixel_fonts_nokiafc22_ttfR5y30:flixel%2Ffonts%2Fnokiafc22.ttfR6tgoR2i29724R3R16R17y36:__ASSET__flixel_fonts_monsterrat_ttfR5y31:flixel%2Ffonts%2Fmonsterrat.ttfR6tgoR0y33:flixel%2Fimages%2Fui%2Fbutton.pngR2i222R3R4R5R22R6tgoR0y36:flixel%2Fimages%2Flogo%2Fdefault.pngR2i484R3R4R5R23R6tgoR0y42:flixel%2Fimages%2Ftransitions%2Fcircle.pngR2i299R3R4R5R24R6tgoR0y53:flixel%2Fimages%2Ftransitions%2Fdiagonal_gradient.pngR2i730R3R4R5R25R6tgoR0y43:flixel%2Fimages%2Ftransitions%2Fdiamond.pngR2i236R3R4R5R26R6tgoR0y42:flixel%2Fimages%2Ftransitions%2Fsquare.pngR2i209R3R4R5R27R6tgoR0y25:data%2Fprotoclimber-1.tmxR2i1282R3R8R5R28R6tgoR0y36:images%2Ftilesets%2Fprotoclimber.pngR2i294R3R4R5R29R6tgh","rootPath":null,"version":2,"libraryArgs":[],"libraryType":null}';
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_tilesets_protoclimber_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_protoclimber_1_tmx extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__data_protoclimber_1_tmx extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__images_tilesets_protoclimber_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__manifest_default_json extends null { }


#elseif (desktop || cpp)

@:keep @:image("assets/images/tilesets/protoclimber.png") @:noCompletion #if display private #end class __ASSET__assets_images_tilesets_protoclimber_png extends lime.graphics.Image {}
@:keep @:file("assets/data/protoclimber-1.tmx") @:noCompletion #if display private #end class __ASSET__assets_data_protoclimber_1_tmx extends haxe.io.Bytes {}
...
@:keep @:file("assets/data/protoclimber-1.tmx") @:noCompletion #if display private #end class __ASSET__data_protoclimber_1_tmx extends haxe.io.Bytes {}
@:keep @:image("assets/images/tilesets/protoclimber.png") @:noCompletion #if display private #end class __ASSET__images_tilesets_protoclimber_png extends lime.graphics.Image {}
